...
pub type EXT_ADDR2_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EXT_ADDR2` writer - EXT_ADDR\\[23:16\\]
The IEEE extended address used during destination address filtering"]
pub type EXT_ADDR2_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EXT_ADDR2_SPEC, u8, u8, 8, O>;
impl R {
...
The IEEE extended address used during destination address filtering"]
    #[inline(always)]
    pub fn ext_addr2(&mut self) -> EXT_ADDR2_W<0> {
