...
bits are don't care."]
pub struct SRCEXTPENDEN0_R(crate::FieldReader<u8, u8>);
impl SRCEXTPENDEN0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        SRCEXTPENDEN0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SRCEXTPENDEN0_R {
