...
pub type EXT_ADDR6_R = crate::FieldReader<u8, u8>;
#[doc = "Field `EXT_ADDR6` writer - EXT_ADDR\\[55:48\\]
The IEEE extended address used during destination address filtering"]
pub type EXT_ADDR6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, EXT_ADDR6_SPEC, u8, u8, 8, O>;
impl R {
...
The IEEE extended address used during destination address filtering"]
    #[inline(always)]
    pub fn ext_addr6(&mut self) -> EXT_ADDR6_W<0> {
