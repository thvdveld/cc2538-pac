...
pub mod dmactl;
#[doc = "LCTL (rw) register accessor: an alias for `Reg<LCTL_SPEC>`"]
...
pub mod lctl;
#[doc = "LSS (r) register accessor: an alias for `Reg<LSS_SPEC>`"]
...
pub mod lss;
#[doc = "LTIM (r) register accessor: an alias for `Reg<LTIM_SPEC>`"]
...
pub mod ltim;
#[doc = "NINEBITADDR (rw) register accessor: an alias for `Reg<NINEBITADDR_SPEC>`"]
...
pub mod ninebitaddr;
#[doc = "NINEBITAMASK (rw) register accessor: an alias for `Reg<NINEBITAMASK_SPEC>`"]
