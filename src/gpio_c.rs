...
pub mod ic;
#[doc = "AFSEL (rw) register accessor: an alias for `Reg<AFSEL_SPEC>`"]
...
pub mod afsel;
#[doc = "GPIOLOCK (rw) register accessor: an alias for `Reg<GPIOLOCK_SPEC>`"]
...
pub mod gpiolock;
#[doc = "GPIOCR (rw) register accessor: an alias for `Reg<GPIOCR_SPEC>`"]
...
pub mod pmux;
#[doc = "P_EDGE_CTRL (rw) register accessor: an alias for `Reg<P_EDGE_CTRL_SPEC>`"]
...
pub mod p_edge_ctrl;
#[doc = "USB_CTRL (rw) register accessor: an alias for `Reg<USB_CTRL_SPEC>`"]
...
pub mod usb_ctrl;
#[doc = "PI_IEN (rw) register accessor: an alias for `Reg<PI_IEN_SPEC>`"]
...
pub mod pi_ien;
#[doc = "IRQ_DETECT_ACK (rw) register accessor: an alias for `Reg<IRQ_DETECT_ACK_SPEC>`"]
...
#[doc = "USB_IRQ_ACK (rw) register accessor: an alias for `Reg<USB_IRQ_ACK_SPEC>`"]
pub type USB_IRQ_ACK = crate::Reg<usb_irq_ack::USB_IRQ_ACK_SPEC>;
#[doc = "Same functionality as IRQ_DETECT_ACK, but for USB"]
pub mod usb_irq_ack;
#[doc = "IRQ_DETECT_UNMASK (rw) register accessor: an alias for `Reg<IRQ_DETECT_UNMASK_SPEC>`"]
