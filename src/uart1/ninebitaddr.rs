...
pub type NINEBITEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr(&mut self) -> ADDR_W<NINEBITADDR_SPEC, 0> {
        ADDR_W::new(self)
    }
    #[doc = "Bit 15 - Enable 9-bit mode 1: 9-bit mode is enabled. 0: 9-bit mode is disabled."]
    #[inline(always)]
    #[must_use]
    pub fn ninebiten(&mut self) -> NINEBITEN_W<NINEBITADDR_SPEC, 15> {
