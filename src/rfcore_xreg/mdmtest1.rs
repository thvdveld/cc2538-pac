...
pub type LOOPBACK_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RFC_SNIFF_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RAMP_AMP_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type MOD_IF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USEMIRROR_IF_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn loopback_en(&mut self) -> LOOPBACK_EN_W<MDMTEST1_SPEC> {
        LOOPBACK_EN_W::new(self, 0)
    }
    #[doc = "Bit 2 - 0: Packet sniffer module disabled 1: Packet sniffer module enabled. The received and transmitted data can be observed on GPIO pins."]
    #[inline(always)]
    #[must_use]
    pub fn rfc_sniff_en(&mut self) -> RFC_SNIFF_EN_W<MDMTEST1_SPEC> {
        RFC_SNIFF_EN_W::new(self, 2)
    }
    #[doc = "Bit 3 - 1: Enable ramping of DAC output amplitude during startup and finish. 0: Disable ramping of DAC output amplitude."]
    #[inline(always)]
    #[must_use]
    pub fn ramp_amp(&mut self) -> RAMP_AMP_W<MDMTEST1_SPEC> {
        RAMP_AMP_W::new(self, 3)
    }
    #[doc = "Bit 4 - 0: Modulation is performed at an IF set by MDMTEST0.TX_TONE. The tone set by MDMTEST0.TX_TONE is superimposed on the data. 1: Modulate a tone set by MDMTEST0.TX_TONE. A tone is transmitted with frequency set by MDMTEST0.TX_TONE."]
    #[inline(always)]
    #[must_use]
    pub fn mod_if(&mut self) -> MOD_IF_W<MDMTEST1_SPEC> {
        MOD_IF_W::new(self, 4)
    }
    #[doc = "Bit 5 - 0: Use the normal IF frequency (MDMTEST0.TX_TONE) for automatic IF compensation of channel frequency on TX. 1: Use mirror IF frequency for automatic compensation of channel frequency on TX."]
    #[inline(always)]
    #[must_use]
    pub fn usemirror_if(&mut self) -> USEMIRROR_IF_W<MDMTEST1_SPEC> {
        USEMIRROR_IF_W::new(self, 5)
    }
