...
pub struct R(crate::R<SRCSHORTEN1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SRCSHORTEN1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SRCSHORTEN1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SRCSHORTEN1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SRCSHORTEN1` writer"]
pub struct W(crate::W<SRCSHORTEN1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SRCSHORTEN1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SRCSHORTEN1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SRCSHORTEN1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SHORT_ADDR_EN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, SRCSHORTEN1_SPEC, u8, u8, 8, O>;
impl R {
