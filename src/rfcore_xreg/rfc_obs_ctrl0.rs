...
pub type RFC_OBS_MUX0_W<'a, REG> = crate::FieldWriter<'a, REG, 6>;
...
pub type RFC_OBS_POL0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rfc_obs_mux0(&mut self) -> RFC_OBS_MUX0_W<RFC_OBS_CTRL0_SPEC> {
        RFC_OBS_MUX0_W::new(self, 0)
    }
    #[doc = "Bit 6 - The signal chosen by RFC_OBS_MUX0 is XORed with this bit."]
    #[inline(always)]
    #[must_use]
    pub fn rfc_obs_pol0(&mut self) -> RFC_OBS_POL0_W<RFC_OBS_CTRL0_SPEC> {
        RFC_OBS_POL0_W::new(self, 6)
    }
