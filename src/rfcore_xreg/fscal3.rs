...
pub type VCO_CAPARR_CAL_CTRL_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type VCO_VC_DAC_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
pub type VCO_DAC_EN_OV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vco_caparr_cal_ctrl(&mut self) -> VCO_CAPARR_CAL_CTRL_W<FSCAL3_SPEC> {
        VCO_CAPARR_CAL_CTRL_W::new(self, 0)
    }
    #[doc = "Bits 2:5 - Bit vector for programming varactor control voltage from VC DAC"]
    #[inline(always)]
    #[must_use]
    pub fn vco_vc_dac(&mut self) -> VCO_VC_DAC_W<FSCAL3_SPEC> {
        VCO_VC_DAC_W::new(self, 2)
    }
    #[doc = "Bit 6 - Enables the VCO DAC when 1"]
    #[inline(always)]
    #[must_use]
    pub fn vco_dac_en_ov(&mut self) -> VCO_DAC_EN_OV_W<FSCAL3_SPEC> {
        VCO_DAC_EN_OV_W::new(self, 6)
    }
