...
pub type R = crate::R<Cspprog15Spec>;
...
#[doc = "CSP program\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cspprog_15::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cspprog15Spec;
impl crate::RegisterSpec for Cspprog15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cspprog_15::R`](R) reader structure"]
impl crate::Readable for Cspprog15Spec {}
#[doc = "`reset()` method sets CSPPROG_15 to value 0"]
impl crate::Resettable for Cspprog15Spec {
