...
pub struct R(crate::R<CSPPROG_10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CSPPROG_10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CSPPROG_10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CSPPROG_10_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CSP program\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cspprog_10](index.html) module"]
