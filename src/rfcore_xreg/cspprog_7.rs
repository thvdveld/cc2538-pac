...
pub type R = crate::R<Cspprog7Spec>;
...
#[doc = "CSP program\n\nYou can [`read`](crate::Reg::read) this register and get [`cspprog_7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cspprog7Spec;
impl crate::RegisterSpec for Cspprog7Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cspprog_7::R`](R) reader structure"]
impl crate::Readable for Cspprog7Spec {}
#[doc = "`reset()` method sets CSPPROG_7 to value 0"]
impl crate::Resettable for Cspprog7Spec {
