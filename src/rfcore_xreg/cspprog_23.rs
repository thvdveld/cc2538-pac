...
pub type R = crate::R<Cspprog23Spec>;
...
#[doc = "CSP program\n\nYou can [`read`](crate::Reg::read) this register and get [`cspprog_23::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Cspprog23Spec;
impl crate::RegisterSpec for Cspprog23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`cspprog_23::R`](R) reader structure"]
impl crate::Readable for Cspprog23Spec {}
#[doc = "`reset()` method sets CSPPROG_23 to value 0"]
impl crate::Resettable for Cspprog23Spec {
