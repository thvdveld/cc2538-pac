...
pub struct R(crate::R<CSPPROG_6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CSPPROG_6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CSPPROG_6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CSPPROG_6_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "CSP program\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cspprog_6](index.html) module"]
pub struct CSPPROG_6_SPEC;
impl crate::RegisterSpec for CSPPROG_6_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cspprog_6::R](R) reader structure"]
impl crate::Readable for CSPPROG_6_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets CSPPROG_6 to value 0"]
impl crate::Resettable for CSPPROG_6_SPEC {
    #[inline(always)]
