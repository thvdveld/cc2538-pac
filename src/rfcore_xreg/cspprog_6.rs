...
pub type R = crate::R<CSPPROG_6_SPEC>;
...
#[doc = "CSP program\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`cspprog_6::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
