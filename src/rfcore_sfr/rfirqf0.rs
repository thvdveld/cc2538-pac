...
pub type ACT_UNUSED_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SFD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FIFOP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SRC_MATCH_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SRC_MATCH_FOUND_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FRAME_ACCEPTED_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RXPKTDONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RXMASKZERO_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn act_unused(&mut self) -> ACT_UNUSED_W<RFIRQF0_SPEC, 0> {
        ACT_UNUSED_W::new(self)
    }
    #[doc = "Bit 1 - SFD has been received or transmitted. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn sfd(&mut self) -> SFD_W<RFIRQF0_SPEC, 1> {
        SFD_W::new(self)
    }
    #[doc = "Bit 2 - The number of bytes in the RX FIFO is greater than the threshold. Also raised when a complete frame is received, and when a packet is read out completely and more complete packets are available. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn fifop(&mut self) -> FIFOP_W<RFIRQF0_SPEC, 2> {
        FIFOP_W::new(self)
    }
    #[doc = "Bit 3 - Source matching is complete. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn src_match_done(&mut self) -> SRC_MATCH_DONE_W<RFIRQF0_SPEC, 3> {
        SRC_MATCH_DONE_W::new(self)
    }
    #[doc = "Bit 4 - Source match is found. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn src_match_found(&mut self) -> SRC_MATCH_FOUND_W<RFIRQF0_SPEC, 4> {
        SRC_MATCH_FOUND_W::new(self)
    }
    #[doc = "Bit 5 - Frame has passed frame filtering. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn frame_accepted(&mut self) -> FRAME_ACCEPTED_W<RFIRQF0_SPEC, 5> {
        FRAME_ACCEPTED_W::new(self)
    }
    #[doc = "Bit 6 - A complete frame has been received. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxpktdone(&mut self) -> RXPKTDONE_W<RFIRQF0_SPEC, 6> {
        RXPKTDONE_W::new(self)
    }
    #[doc = "Bit 7 - The RXENABLE register has gone from a nonzero state to an all-zero state. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxmaskzero(&mut self) -> RXMASKZERO_W<RFIRQF0_SPEC, 7> {
