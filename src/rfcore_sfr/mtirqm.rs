...
pub type MACTIMER_PERM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MACTIMER_COMPARE1M_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MACTIMER_COMPARE2M_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MACTIMER_OVF_PERM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MACTIMER_OVF_COMPARE1M_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MACTIMER_OVF_COMPARE2M_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mactimer_perm(&mut self) -> MACTIMER_PERM_W<MTIRQM_SPEC, 0> {
        MACTIMER_PERM_W::new(self)
    }
    #[doc = "Bit 1 - Enables the MACTIMER_COMPARE1 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_compare1m(&mut self) -> MACTIMER_COMPARE1M_W<MTIRQM_SPEC, 1> {
        MACTIMER_COMPARE1M_W::new(self)
    }
    #[doc = "Bit 2 - Enables the MACTIMER_COMPARE2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_compare2m(&mut self) -> MACTIMER_COMPARE2M_W<MTIRQM_SPEC, 2> {
        MACTIMER_COMPARE2M_W::new(self)
    }
    #[doc = "Bit 3 - Enables the MACTIMER_OVF_PER interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_ovf_perm(&mut self) -> MACTIMER_OVF_PERM_W<MTIRQM_SPEC, 3> {
        MACTIMER_OVF_PERM_W::new(self)
    }
    #[doc = "Bit 4 - Enables the MACTIMER_OVF_COMPARE1 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_ovf_compare1m(&mut self) -> MACTIMER_OVF_COMPARE1M_W<MTIRQM_SPEC, 4> {
        MACTIMER_OVF_COMPARE1M_W::new(self)
    }
    #[doc = "Bit 5 - Enables the MACTIMER_OVF_COMPARE2 interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_ovf_compare2m(&mut self) -> MACTIMER_OVF_COMPARE2M_W<MTIRQM_SPEC, 5> {
