...
pub type NLOCK_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RXABO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RXOVERF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type RXUNDERF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TXOVERF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type TXUNDERF_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type STROBEERR_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nlock(&mut self) -> NLOCK_W<RFERRF_SPEC> {
        NLOCK_W::new(self, 0)
    }
    #[doc = "Bit 1 - Reception of a frame was aborted. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxabo(&mut self) -> RXABO_W<RFERRF_SPEC> {
        RXABO_W::new(self, 1)
    }
    #[doc = "Bit 2 - RX FIFO overflowed. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxoverf(&mut self) -> RXOVERF_W<RFERRF_SPEC> {
        RXOVERF_W::new(self, 2)
    }
    #[doc = "Bit 3 - RX FIFO underflowed. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn rxunderf(&mut self) -> RXUNDERF_W<RFERRF_SPEC> {
        RXUNDERF_W::new(self, 3)
    }
    #[doc = "Bit 4 - TX FIFO overflowed. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn txoverf(&mut self) -> TXOVERF_W<RFERRF_SPEC> {
        TXOVERF_W::new(self, 4)
    }
    #[doc = "Bit 5 - TX FIFO underflowed. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn txunderf(&mut self) -> TXUNDERF_W<RFERRF_SPEC> {
        TXUNDERF_W::new(self, 5)
    }
    #[doc = "Bit 6 - A command strobe was issued when it could not be processed. Triggered if trying to disable the radio when it is already disabled, or when trying to do a SACK, SACKPEND, or SNACK command when not in active RX. 0: No interrupt pending 1: Interrupt pending"]
    #[inline(always)]
    #[must_use]
    pub fn strobeerr(&mut self) -> STROBEERR_W<RFERRF_SPEC> {
        STROBEERR_W::new(self, 6)
    }
