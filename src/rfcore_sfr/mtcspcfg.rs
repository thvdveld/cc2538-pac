...
pub type MACTIMER_EVENT1_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type MACTIMER_EVENMT_CFG_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mactimer_event1_cfg(&mut self) -> MACTIMER_EVENT1_CFG_W<MTCSPCFG_SPEC> {
        MACTIMER_EVENT1_CFG_W::new(self, 0)
    }
    #[doc = "Bits 4:6 - Selects the event that triggers an MT_EVENT2 pulse 000: MT_per_event 001: MT_cmp1_event 010: MT_cmp2_event 011: MTovf_per_event 100: MTovf_cmp1_event 101: MTovf_cmp2_event 110: Reserved 111: No event"]
    #[inline(always)]
    #[must_use]
    pub fn mactimer_evenmt_cfg(&mut self) -> MACTIMER_EVENMT_CFG_W<MTCSPCFG_SPEC> {
        MACTIMER_EVENMT_CFG_W::new(self, 4)
    }
