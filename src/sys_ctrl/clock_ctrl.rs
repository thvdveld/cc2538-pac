...
pub type SYS_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type IO_DIV_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
pub type OSC_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSC_PD_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type AMP_DET_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSC32K_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type OSC32K_CALDIS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sys_div(&mut self) -> SYS_DIV_W<CLOCK_CTRL_SPEC> {
        SYS_DIV_W::new(self, 0)
    }
    #[doc = "Bits 8:10 - I/O clock rate setting Cannot be higher than OSC setting 000: 32 MHz 001: 16 MHz 010: 8 MHz 011: 4 MHz 100: 2 MHz 101: 1 MHz 110: 0.5 MHz 111: 0.25 MHz"]
    #[inline(always)]
    #[must_use]
    pub fn io_div(&mut self) -> IO_DIV_W<CLOCK_CTRL_SPEC> {
        IO_DIV_W::new(self, 8)
    }
    #[doc = "Bit 16 - System clock oscillator selection 0: 32-MHz crystal oscillator 1: 16-MHz HF-RC oscillator"]
    #[inline(always)]
    #[must_use]
    pub fn osc(&mut self) -> OSC_W<CLOCK_CTRL_SPEC> {
        OSC_W::new(self, 16)
    }
    #[doc = "Bit 17 - 0: Power up both oscillators 1: Power down oscillator not selected by OSC bit (hardware-controlled when selected)."]
    #[inline(always)]
    #[must_use]
    pub fn osc_pd(&mut self) -> OSC_PD_W<CLOCK_CTRL_SPEC> {
        OSC_PD_W::new(self, 17)
    }
    #[doc = "Bit 21 - Amplitude detector of XOSC during power up 0: No action 1: Delay qualification of XOSC until amplitude is greater than the threshold."]
    #[inline(always)]
    #[must_use]
    pub fn amp_det(&mut self) -> AMP_DET_W<CLOCK_CTRL_SPEC> {
        AMP_DET_W::new(self, 21)
    }
    #[doc = "Bit 24 - 32-kHz clock oscillator selection 0: 32-kHz crystal oscillator 1: 32-kHz RC oscillator"]
    #[inline(always)]
    #[must_use]
    pub fn osc32k(&mut self) -> OSC32K_W<CLOCK_CTRL_SPEC> {
        OSC32K_W::new(self, 24)
    }
    #[doc = "Bit 25 - Disable calibration 32-kHz RC oscillator. 0: Enable calibration 1: Disable calibration"]
    #[inline(always)]
    #[must_use]
    pub fn osc32k_caldis(&mut self) -> OSC32K_CALDIS_W<CLOCK_CTRL_SPEC> {
        OSC32K_CALDIS_W::new(self, 25)
    }
