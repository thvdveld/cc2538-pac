...
pub type R = crate::R<DCGCGPT_SPEC>;
#[doc = "Register `DCGCGPT` writer"]
pub type W = crate::W<DCGCGPT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpt0(&mut self) -> GPT0_W<DCGCGPT_SPEC, 0> {
        GPT0_W::new(self)
    }
    #[doc = "Bit 1 - 0: Clock for GPT1 is gated. 1: Clock for GPT1 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt1(&mut self) -> GPT1_W<DCGCGPT_SPEC, 1> {
        GPT1_W::new(self)
    }
    #[doc = "Bit 2 - 0: Clock for GPT2 is gated. 1: Clock for GPT2 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt2(&mut self) -> GPT2_W<DCGCGPT_SPEC, 2> {
        GPT2_W::new(self)
    }
    #[doc = "Bit 3 - 0: Clock for GPT3 is gated. 1: Clock for GPT3 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt3(&mut self) -> GPT3_W<DCGCGPT_SPEC, 3> {
        GPT3_W::new(self)
    }
...
when the CPU is in PM0. This register setting is don't care for PM1-3, because the system clock is powered down in these modes.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`dcgcgpt::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`dcgcgpt::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
