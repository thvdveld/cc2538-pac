...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpt0(&mut self) -> GPT0_W<DCGCGPT_SPEC> {
        GPT0_W::new(self, 0)
    }
    #[doc = "Bit 1 - 0: Clock for GPT1 is gated. 1: Clock for GPT1 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt1(&mut self) -> GPT1_W<DCGCGPT_SPEC> {
        GPT1_W::new(self, 1)
    }
    #[doc = "Bit 2 - 0: Clock for GPT2 is gated. 1: Clock for GPT2 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt2(&mut self) -> GPT2_W<DCGCGPT_SPEC> {
        GPT2_W::new(self, 2)
    }
    #[doc = "Bit 3 - 0: Clock for GPT3 is gated. 1: Clock for GPT3 is enabled."]
    #[inline(always)]
    #[must_use]
    pub fn gpt3(&mut self) -> GPT3_W<DCGCGPT_SPEC> {
        GPT3_W::new(self, 3)
    }
