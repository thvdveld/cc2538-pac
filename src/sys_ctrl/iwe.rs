...
pub type PORT_A_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PORT_B_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PORT_C_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PORT_D_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type USB_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type SM_TIMER_IWE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn port_a_iwe(&mut self) -> PORT_A_IWE_W<IWE_SPEC> {
        PORT_A_IWE_W::new(self, 0)
    }
    #[doc = "Bit 1 - 1: Enable port B wake-up interrupt. 0: Disable port B wake-up interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn port_b_iwe(&mut self) -> PORT_B_IWE_W<IWE_SPEC> {
        PORT_B_IWE_W::new(self, 1)
    }
    #[doc = "Bit 2 - 1: Enable port C wake-up interrupt. 0: Disable port C wake-up interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn port_c_iwe(&mut self) -> PORT_C_IWE_W<IWE_SPEC> {
        PORT_C_IWE_W::new(self, 2)
    }
    #[doc = "Bit 3 - 1: Enable port D wake-up interrupt. 0: Disable port D wake-up interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn port_d_iwe(&mut self) -> PORT_D_IWE_W<IWE_SPEC> {
        PORT_D_IWE_W::new(self, 3)
    }
    #[doc = "Bit 4 - 1: Enable USB wake-up interrupt. 0: Disable USB wake-up interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn usb_iwe(&mut self) -> USB_IWE_W<IWE_SPEC> {
        USB_IWE_W::new(self, 4)
    }
    #[doc = "Bit 5 - 1: Enable SM Timer wake-up interrupt. 0: Disable SM Timer wake-up interrupt."]
    #[inline(always)]
    #[must_use]
    pub fn sm_timer_iwe(&mut self) -> SM_TIMER_IWE_W<IWE_SPEC> {
        SM_TIMER_IWE_W::new(self, 5)
    }
