...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpt0(&mut self) -> GPT0_W<SRGPT_SPEC> {
        GPT0_W::new(self, 0)
    }
    #[doc = "Bit 1 - 0: GPT1 module is not reset 1: GPT1 module is reset"]
    #[inline(always)]
    #[must_use]
    pub fn gpt1(&mut self) -> GPT1_W<SRGPT_SPEC> {
        GPT1_W::new(self, 1)
    }
    #[doc = "Bit 2 - 0: GPT2 module is not reset 1: GPT2 module is reset"]
    #[inline(always)]
    #[must_use]
    pub fn gpt2(&mut self) -> GPT2_W<SRGPT_SPEC> {
        GPT2_W::new(self, 2)
    }
    #[doc = "Bit 3 - 0: GPT3 module is not reset 1: GPT3 module is reset"]
    #[inline(always)]
    #[must_use]
    pub fn gpt3(&mut self) -> GPT3_W<SRGPT_SPEC> {
        GPT3_W::new(self, 3)
    }
