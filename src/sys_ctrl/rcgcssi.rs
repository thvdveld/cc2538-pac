...
pub type R = crate::R<RcgcssiSpec>;
#[doc = "Register `RCGCSSI` writer"]
pub type W = crate::W<RcgcssiSpec>;
...
impl W {
    #[doc = "Bit 0 - 0: Clock for SSI0 is gated. 1: Clock for SSI0 is enabled."]
    #[inline(always)]
    pub fn ssi0(&mut self) -> Ssi0W<RcgcssiSpec> {
        Ssi0W::new(self, 0)
    }
    #[doc = "Bit 1 - 0: Clock for SSI1 is gated. 1: Clock for SSI1 is enabled."]
    #[inline(always)]
    pub fn ssi1(&mut self) -> Ssi1W<RcgcssiSpec> {
        Ssi1W::new(self, 1)
    }
}
#[doc = "This register defines the module clocks for SSI\\[1:0\\]
when the CPU is in active (run) mode. This register setting is don't care for PM1-3, because the system clock is powered down in these modes.\n\nYou can [`read`](crate::Reg::read) this register and get [`rcgcssi::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcgcssi::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RcgcssiSpec;
impl crate::RegisterSpec for RcgcssiSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`rcgcssi::R`](R) reader structure"]
impl crate::Readable for RcgcssiSpec {}
#[doc = "`write(|w| ..)` method takes [`rcgcssi::W`](W) writer structure"]
impl crate::Writable for RcgcssiSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets RCGCSSI to value 0"]
impl crate::Resettable for RcgcssiSpec {
