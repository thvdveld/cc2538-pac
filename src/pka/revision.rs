...
impl core::ops::Deref for MAJOR_HW_REVISION_R {
...
impl core::ops::Deref for MINOR_HW_REVISION_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl core::ops::Deref for COMPLEMENT_OF_BASIC_EIP_NUMBER_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl core::ops::Deref for BASIC_EIP_NUMBER_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
