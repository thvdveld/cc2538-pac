#![doc = "Peripheral access API for CC2538SF53 microcontrollers (generated using svd2rust v0.35.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Peripherals {
    ...
    pub unsafe fn steal() -> Self {
        ...
        Peripherals {
            ...
            rfcore_ffsm: RfcoreFfsm::steal(),
            rfcore_xreg: RfcoreXreg::steal(),
            rfcore_sfr: RfcoreSfr::steal(),
            usb: Usb::steal(),
            aes: Aes::steal(),
            sys_ctrl: SysCtrl::steal(),
            flash_ctrl: FlashCtrl::steal(),
            ioc: Ioc::steal(),
            smwdthrosc: Smwdthrosc::steal(),
            ana_regs: AnaRegs::steal(),
            soc_adc: SocAdc::steal(),
            gpio_a: GpioA::steal(),
            gpio_b: GpioB::steal(),
            gpio_c: GpioC::steal(),
            gpio_d: GpioD::steal(),
