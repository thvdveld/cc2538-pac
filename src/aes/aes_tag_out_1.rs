...
pub struct R(crate::R<AES_TAG_OUT_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AES_TAG_OUT_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AES_TAG_OUT_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AES_TAG_OUT_1_SPEC>) -> Self {
        R(reader)
    }
}
