...
pub struct R(crate::R<HASH_DIGEST_C_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HASH_DIGEST_C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HASH_DIGEST_C_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HASH_DIGEST_C_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HASH_DIGEST_C` writer"]
pub struct W(crate::W<HASH_DIGEST_C_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HASH_DIGEST_C_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HASH_DIGEST_C_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HASH_DIGEST_C_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type HASH_DIGEST_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HASH_DIGEST_C_SPEC, u32, u32, 32, O>;
impl R {
