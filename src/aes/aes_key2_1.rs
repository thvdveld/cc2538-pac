...
pub type W = crate::W<AesKey2_1Spec>;
...
- ZEROES - This register must remain 0."]
    #[inline(always)]
    #[must_use]
    pub fn aes_key2(&mut self) -> AesKey2W<AesKey2_1Spec> {
        AesKey2W::new(self, 0)
    }
}
...
pub struct AesKey2_1Spec;
impl crate::RegisterSpec for AesKey2_1Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`aes_key2_1::W`](W) writer structure"]
impl crate::Writable for AesKey2_1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AES_KEY2_1 to value 0"]
impl crate::Resettable for AesKey2_1Spec {
