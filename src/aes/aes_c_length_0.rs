...
impl core::ops::Deref for W {
    type Target = crate::W<AES_C_LENGTH_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AES_C_LENGTH_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AES_C_LENGTH_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type C_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AES_C_LENGTH_0_SPEC, u32, u32, 32, O>;
impl W {
