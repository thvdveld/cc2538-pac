...
pub type W = crate::W<AesKey3_1Spec>;
...
- ZEROES - This register must remain 0."]
    #[inline(always)]
    #[must_use]
    pub fn aes_key3(&mut self) -> AesKey3W<AesKey3_1Spec> {
        AesKey3W::new(self, 0)
    }
}
...
pub struct AesKey3_1Spec;
impl crate::RegisterSpec for AesKey3_1Spec {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`aes_key3_1::W`](W) writer structure"]
impl crate::Writable for AesKey3_1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets AES_KEY3_1 to value 0"]
impl crate::Resettable for AesKey3_1Spec {
