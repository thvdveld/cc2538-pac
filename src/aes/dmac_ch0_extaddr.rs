...
pub type R = crate::R<DmacCh0ExtaddrSpec>;
#[doc = "Register `DMAC_CH0_EXTADDR` writer"]
pub type W = crate::W<DmacCh0ExtaddrSpec>;
...
impl W {
    #[doc = "Bits 0:31 - Channel external address value When read during operation, it holds the last updated external address after being sent to the master interface."]
    #[inline(always)]
    pub fn addr(&mut self) -> AddrW<DmacCh0ExtaddrSpec> {
        AddrW::new(self, 0)
    }
}
#[doc = "Channel external address\n\nYou can [`read`](crate::Reg::read) this register and get [`dmac_ch0_extaddr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmac_ch0_extaddr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DmacCh0ExtaddrSpec;
impl crate::RegisterSpec for DmacCh0ExtaddrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dmac_ch0_extaddr::R`](R) reader structure"]
impl crate::Readable for DmacCh0ExtaddrSpec {}
#[doc = "`write(|w| ..)` method takes [`dmac_ch0_extaddr::W`](W) writer structure"]
impl crate::Writable for DmacCh0ExtaddrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DMAC_CH0_EXTADDR to value 0"]
impl crate::Resettable for DmacCh0ExtaddrSpec {
