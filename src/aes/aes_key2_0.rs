...
pub struct W(crate::W<AES_KEY2_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AES_KEY2_0_SPEC>;
    #[inline(always)]
...
impl From<crate::W<AES_KEY2_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AES_KEY2_0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AES_KEY2_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, AES_KEY2_0_SPEC, u32, u32, 32, O>;
impl W {
