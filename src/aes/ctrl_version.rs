...
pub type R = crate::R<CTRL_VERSION_SPEC>;
...
pub type PATCH_LEVEL_R = crate::FieldReader;
#[doc = "Field `MINOR_VERSION` reader - Minor version number"]
pub type MINOR_VERSION_R = crate::FieldReader;
#[doc = "Field `MAJOR_VERSION` reader - Major version number"]
pub type MAJOR_VERSION_R = crate::FieldReader;
impl R {
