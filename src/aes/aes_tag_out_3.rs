...
pub type R = crate::R<AesTagOut3Spec>;
...
pub struct AesTagOut3Spec;
impl crate::RegisterSpec for AesTagOut3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aes_tag_out_3::R`](R) reader structure"]
impl crate::Readable for AesTagOut3Spec {}
#[doc = "`reset()` method sets AES_TAG_OUT_3 to value 0"]
impl crate::Resettable for AesTagOut3Spec {
