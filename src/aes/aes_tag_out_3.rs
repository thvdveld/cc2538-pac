#[doc = "Register `AES_TAG_OUT_3` reader"]
pub struct R(crate::R<AES_TAG_OUT_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AES_TAG_OUT_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AES_TAG_OUT_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AES_TAG_OUT_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `AES_TAG` reader - AES_TAG\\[127:96\\]
