...
pub type I2C0TME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type T0TME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type T1TME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MTTME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type T3TME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn i2c0tme(&mut self) -> I2C0TME_W<PTME2_SPEC, 0> {
        I2C0TME_W::new(self)
    }
    #[doc = "Bit 16 - Timer0 test mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn t0tme(&mut self) -> T0TME_W<PTME2_SPEC, 16> {
        T0TME_W::new(self)
    }
    #[doc = "Bit 17 - Timer1 test mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn t1tme(&mut self) -> T1TME_W<PTME2_SPEC, 17> {
        T1TME_W::new(self)
    }
    #[doc = "Bit 18 - MacTimer test mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn mttme(&mut self) -> MTTME_W<PTME2_SPEC, 18> {
        MTTME_W::new(self)
    }
    #[doc = "Bit 19 - Timer3 test mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn t3tme(&mut self) -> T3TME_W<PTME2_SPEC, 19> {
        T3TME_W::new(self)
    }
