...
pub type PB1_OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PB1_over` writer - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
pub type PB1_OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PB1_OVER_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
    #[inline(always)]
    pub fn pb1_over(&mut self) -> PB1_OVER_W<0> {
        PB1_OVER_W::new(self)
    }
