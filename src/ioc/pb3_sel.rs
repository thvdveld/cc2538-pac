...
pub struct R(crate::R<PB3_SEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PB3_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PB3_SEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PB3_SEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PB3_SEL` writer"]
pub struct W(crate::W<PB3_SEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PB3_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PB3_SEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PB3_SEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PB3_sel` reader - Select one peripheral signal output for PB3."]
pub type PB3_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PB3_sel` writer - Select one peripheral signal output for PB3."]
pub type PB3_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PB3_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pb3_sel(&mut self) -> PB3_SEL_W<0> {
        PB3_SEL_W::new(self)
    }
