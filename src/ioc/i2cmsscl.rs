...
pub struct R(crate::R<I2CMSSCL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2CMSSCL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2CMSSCL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2CMSSCL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2CMSSCL` writer"]
pub struct W(crate::W<I2CMSSCL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2CMSSCL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2CMSSCL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2CMSSCL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INPUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, I2CMSSCL_SPEC, u8, u8, 5, O>;
impl R {
