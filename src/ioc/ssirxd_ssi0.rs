...
pub type R = crate::R<SSIRXD_SSI0_SPEC>;
#[doc = "Register `SSIRXD_SSI0` writer"]
pub type W = crate::W<SSIRXD_SSI0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn input_sel(&mut self) -> INPUT_SEL_W<SSIRXD_SSI0_SPEC, 0> {
...
#[doc = "Selects one of the 32 pins on the four 8-pin I/O-ports (port A, port B, port C, and port D) to be the SSI0 RX.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ssirxd_ssi0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ssirxd_ssi0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
