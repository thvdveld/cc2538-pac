...
pub type PA2_OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PA2_over` writer - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
pub type PA2_OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PA2_OVER_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa2_over(&mut self) -> PA2_OVER_W<0> {
        PA2_OVER_W::new(self)
    }
