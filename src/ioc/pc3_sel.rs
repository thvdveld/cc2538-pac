...
pub type PC3_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PC3_sel` writer - Select one peripheral signal output for PC3."]
pub type PC3_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PC3_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - Select one peripheral signal output for PC3."]
    #[inline(always)]
    pub fn pc3_sel(&mut self) -> PC3_SEL_W<0> {
        PC3_SEL_W::new(self)
    }
