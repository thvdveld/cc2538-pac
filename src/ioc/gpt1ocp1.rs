...
pub type R = crate::R<GPT1OCP1_SPEC>;
#[doc = "Register `GPT1OCP1` writer"]
pub type W = crate::W<GPT1OCP1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn input_sel(&mut self) -> INPUT_SEL_W<GPT1OCP1_SPEC, 0> {
