...
pub type PD4_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PD4_sel` writer - Select one peripheral signal output for PD4."]
pub type PD4_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PD4_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd4_sel(&mut self) -> PD4_SEL_W<0> {
        PD4_SEL_W::new(self)
    }
