...
pub type PD3_OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PD3_over` writer - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
pub type PD3_OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PD3_OVER_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd3_over(&mut self) -> PD3_OVER_W<0> {
        PD3_OVER_W::new(self)
    }
