...
pub type PA6_OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PA6_over` writer - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
pub type PA6_OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PA6_OVER_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa6_over(&mut self) -> PA6_OVER_W<0> {
        PA6_OVER_W::new(self)
    }
