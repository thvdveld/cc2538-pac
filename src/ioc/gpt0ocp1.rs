...
pub struct R(crate::R<GPT0OCP1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPT0OCP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPT0OCP1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPT0OCP1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPT0OCP1` writer"]
pub struct W(crate::W<GPT0OCP1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPT0OCP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPT0OCP1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPT0OCP1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INPUT_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GPT0OCP1_SPEC, u8, u8, 5, O>;
impl R {
