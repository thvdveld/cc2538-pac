...
pub struct R(crate::R<CLK_SSI_SSI1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_SSI_SSI1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_SSI_SSI1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_SSI_SSI1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_SSI_SSI1` writer"]
pub struct W(crate::W<CLK_SSI_SSI1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_SSI_SSI1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_SSI_SSI1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_SSI_SSI1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INPUT_SEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLK_SSI_SSI1_SPEC, u8, u8, 5, O>;
impl R {
