...
pub struct R(crate::R<SSIRXD_SSI1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSIRXD_SSI1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSIRXD_SSI1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSIRXD_SSI1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSIRXD_SSI1` writer"]
pub struct W(crate::W<SSIRXD_SSI1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSIRXD_SSI1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SSIRXD_SSI1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SSIRXD_SSI1_SPEC>) -> Self {
        W(writer)
    }
}
