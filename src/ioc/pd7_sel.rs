...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd7_sel(&mut self) -> PD7_SEL_W<PD7_SEL_SPEC> {
        PD7_SEL_W::new(self, 0)
    }
...
#[doc = "Peripheral select control for PD7\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pd7_sel::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pd7_sel::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
