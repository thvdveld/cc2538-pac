...
pub type PA5_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PA5_sel` writer - Select one peripheral signal output for PA5."]
pub type PA5_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PA5_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa5_sel(&mut self) -> PA5_SEL_W<0> {
        PA5_SEL_W::new(self)
    }
