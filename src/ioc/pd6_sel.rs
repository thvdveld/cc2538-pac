...
pub struct R(crate::R<PD6_SEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PD6_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PD6_SEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PD6_SEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PD6_SEL` writer"]
pub struct W(crate::W<PD6_SEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PD6_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PD6_SEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PD6_SEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PD6_sel` reader - Select one peripheral signal output for PD6."]
pub type PD6_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PD6_sel` writer - Select one peripheral signal output for PD6."]
pub type PD6_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PD6_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd6_sel(&mut self) -> PD6_SEL_W<0> {
        PD6_SEL_W::new(self)
    }
