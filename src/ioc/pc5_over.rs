...
pub type PC5_OVER_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PC5_over` writer - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
pub type PC5_OVER_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PC5_OVER_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - 0x8: oe - output enable 0x4: pue - pullup enable 0x2: pde - pulldown enable 0x1: ana - analog enable"]
    #[inline(always)]
    pub fn pc5_over(&mut self) -> PC5_OVER_W<0> {
        PC5_OVER_W::new(self)
    }
