...
pub struct R(crate::R<PA3_SEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PA3_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PA3_SEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PA3_SEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PA3_SEL` writer"]
pub struct W(crate::W<PA3_SEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PA3_SEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PA3_SEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PA3_SEL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PA3_sel` reader - Select one peripheral signal output for PA3."]
pub type PA3_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PA3_sel` writer - Select one peripheral signal output for PA3."]
pub type PA3_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PA3_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa3_sel(&mut self) -> PA3_SEL_W<0> {
        PA3_SEL_W::new(self)
    }
