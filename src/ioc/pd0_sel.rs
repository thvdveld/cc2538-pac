...
pub type PD0_SEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PD0_sel` writer - Select one peripheral signal output for PD0."]
pub type PD0_SEL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PD0_SEL_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd0_sel(&mut self) -> PD0_SEL_W<0> {
        PD0_SEL_W::new(self)
    }
